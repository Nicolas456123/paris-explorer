// ===== PARIS EXPLORER - VERSION REFACTORISÉE =====
...
class ParisExplorer {
    ...
    /**
     * @deprecated Utilisez app.dataManager.createPlaceId() à la place
     * Méthode conservée pour compatibilité temporaire
     */
    createPlaceId(arrKey, catKey, placeName) {
        console.warn('⚠️ app.createPlaceId() est déprécié. Utilisez app.dataManager.createPlaceId()');
